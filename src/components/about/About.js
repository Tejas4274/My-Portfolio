    ...
    <>
      <section className="about" id="about">
        <div className="about-img">
          <img src={Tejas} alt="My Image" loading="lazy" />
        </div>
        ...
        <div className="parent">
          <div className="card">
            <div className="content-box">
              <span className="card-title">Full Stack Java Developer</span>
              <p className="card-content">Seed Infotech Private Limited</p>
