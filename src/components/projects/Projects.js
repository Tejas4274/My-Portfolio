    ...
    <section className="projects" id="projects">
      ...
      <div className="project-content">
        <div className="image-container">
          ...
          <div className="project-info">
            <h2 className="project-heading">Real Time Chat Application</h2>
            <p className="project-details">
              • Architected and developed a full-stack real-time chat
              application using React.js, Vite, and Firebase.
              <br />
              • Implemented robust features including secure user
              authentication,
              <br />
              dynamic profile management, real-time messaging, and image
              sharing.
              <br />
              • Optimized application for high performance and scalability,{" "}
              <br />
              ensuring a seamless user experience and efficient data handling.
            </p>

            <a
              href="https://github.com/Tejas4274/Real-Time-Chat-Application.git"
      ...
      <div className="project-content">
        <div className="image-container">
          ...
          <div className="project-info">
            <h2 className="project-heading">Car Selling Website</h2>
            <p className="project-details">
              • Developed a local car-selling platform using Angular and Spring
              Boot,
              <br /> implementing REST APIs for seamless frontend-backend
              communication. <br />
              • Designed a user-friendly interface for browsing, searching, and
              purchasing cars,
              <br /> integrating payment processing and user reviews.
            </p>

            <a
              href="https://github.com/Tejas4274/Car-Selling-Website.git"
              className="btn-github"
            >
              <svg
                width="16"
      ...
      <div className="project-content">
        <div className="image-container">
          ...
          <div className="project-info">
            <h2 className="project-heading">Google Gemini Clone</h2>
            <p className="project-details">
              • Replicated core functionalities of the Google Gemini Platform
              using React.js <br /> as the frontend framework and Gemini API for
              backend interactions. <br /> • Achieved real-time data
              synchronization, enhancing user experience with responsive <br />{" "}
              design and efficient state management.
            </p>

            <a
              href="https://github.com/Tejas4274/Google-Gemini.git"
              className="btn-github"
            >
              <svg
                width="16"
